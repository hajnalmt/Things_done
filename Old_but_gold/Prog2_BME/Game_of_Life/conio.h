#ifndef CONIO_H				
#define CONIO_H
#ifdef _WIN32				//Ha Windows alatt fut a programunk akkor lesz ez igaz			
#include <conio.h>
#include <cstdlib>
void clrscr() {
	system("cls");			//System parancs a képernyő törlésére
}
#else						//Ha Linux alatt fut akkor ide jutunk
