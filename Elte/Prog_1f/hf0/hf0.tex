		...
		\begin{enumerate}		
			...
			\item \textbf{Különleges} esetek
				\begin{enumerate}
					...
					\item Nem érvényes teszteset, ha a signed integer érték maximumánál $2^31-1=2147483657$-nél nagyobb vagy minimumánál kisebb $-2^31=-21474836578$-nál értéket tartalmaz a teszt.
				\end{enumerate} 
		\end{enumerate}
