...
\begin{document}
	...
	&Ef=(t=t'~\wedge~|t'|>0~\wedge~t.azon\uparrow(t.ido\uparrow))\\
	&Uf=((y = \bigoplus_{e\in t'} <(bevetel,~elso.nev)=\sum\limits_{e\in t'~\wedge~elso.nev = e.nev}{(e.ar*e.adag)}~\wedge~\\
