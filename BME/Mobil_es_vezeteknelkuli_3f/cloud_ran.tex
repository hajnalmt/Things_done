...
% Main variables
%--------------------------------------------------------------------------------------
\newcommand{\vikszerzo}{Hajnal Ádám \& Hajnal Máté}
\newcommand{\vikkonzulens}{Dr. Fazekas Péter}
\newcommand{\vikcim}{Felhő alapú rádiós hozzáférési hálózat (Cloud-RAN)}
\newcommand{\viktanszek}{BME Hálózati rendszerek és Szolgáltatások Tanszék}
\newcommand{\vikdoktipus}{Mobil és vezetéknélküli hálózatok - Házi feladat}
